...
export default function Customize() {
  return (
    <div className="flex flex-col items-center gap-5 justify-center text-center mx-16 xl:mx-96 lg:mx-40 mb-[150px] font-main">
      ...
      <div className="flex flex-col gap-5 lg:relative lg:w-[880px] lg:h-[569px] justify-center items-center">
        <div className="lg:absolute -left-7 flex flex-col justify-between items-center border border-[#1F64FF] p-7 gap-5 rounded-lg w-[320px] h-[450px]">
        ...
        <div className="lg:absolute flex flex-col justify-center items-center gap-5 bg-[#1F64FF] px-10 py-7 rounded-lg text-white w-[320px] h-[500px]">
          <h2 className="font-main font-bold text-3xl">Personal</h2>
          <h1 className="before:content-['$'] before:align-[200%] before:pr-1 before:opacity-35 before:font-normal after:font-normal after:content-['/m'] text-7xl before:text-sm font-main font-bold after:opacity-35 after:text-sm">
            5
          </h1>
          <div className="flex gap-1 rounded-[5px] bg-[#6293FF] p-1 text-sm">
        ...
        <div className="lg:absolute -right-7 flex flex-col justify-between items-center border border-[#1F64FF] gap-5 p-7 rounded-lg w-[320px] lg:h-[450px]">
          <h2 className="font-main font-bold text-3xl">Team</h2>
          <h1 className="before:content-['$'] before:align-[200%] before:pr-1 before:opacity-35 before:font-normal after:font-normal after:content-['/m'] text-7xl before:text-sm font-main font-bold after:opacity-35 after:text-sm">
            10
          </h1>
          <ul className="lg:h-28 list-image-checkmark lg:text-sm w-60">
            <li>
